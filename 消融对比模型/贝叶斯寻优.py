"""
贝叶斯超参数搜索 — 对比/消融模型通用脚本

用法:
    python 消融对比模型/贝叶斯寻优.py --model ptca --dataset xjtu_batch1 --seq_len 32 --trials 15
    python 消融对比模型/贝叶斯寻优.py --model bigru --dataset xjtu_batch1 --seq_len 32 --trials 15
    python 消融对比模型/贝叶斯寻优.py --model main --dataset calce --seq_len 32 --trials 30

可选模型: ptca, bigru, tcn, noattn, residual, main
"""
...
def main():
    ...
    parser.add_argument("--model", type=str, default="main",
                        ...
                        help="模型: ptca/bigru/tcn/noattn/residual/main")
    ...
    print(f"模型: {args.model} ({ModelClass.__name__})")
